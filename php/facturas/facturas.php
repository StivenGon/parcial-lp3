...
<head>
    ...
    <link href="/codigo-base/css/bootstrap.min.css" rel="stylesheet" />
    <link href="/v/css/datatables.min.css" rel="stylesheet" />

    <script src="/codigo-base/js/bootstrap.bundle.min.js"></script>
    <script src="/codigo-base/js/datatables.min.js"></script>
...
<body>
    ...
    $consulta = mysqli_query($con, "insert into facturas() values ()") or
        ...
        <div class="row mt-4">
            <div class="col-md">
                <div class="form-group row">
                    <label for="CodigoFactura" class="col-lg-3 col-form-label">Número de factura:
                    </label>
                    <div class="col-lg-3">
                        <input
                        type="text"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#btnConfirmarAgregarProducto').click(function() {
                ...
                $("#ModalProducto").modal('hide');
                if ($("#Cantidad").val() == "") { //Controlamos que no esté vacío la cantidad de
                    productos
