...
where codigofactura=$_GET[codigofactura]") or
...
foreach ($resultado as $fila) {
    ...
    echo '<td class="text-right"><a class="btn btn-danger"
    onclick="borrarItem(' . $fila['coddetalle'] . ')" role="button" href="#"
    id="' . $fila['coddetalle'] . '">Borrar</a></td>';
    echo "</tr>";
...
echo "<td class=\"text-right\"><strong>" . number_format(round($pago, 2), 0, '.', '') . "
</strong></td>";
echo "<td></td>";
echo "</tr>";
?>